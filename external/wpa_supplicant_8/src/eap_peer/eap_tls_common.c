...
/*-----------------------------------------------------------------------------*/
/*12-12-05|  Jie.Zhang      |PR359556  |  Add patch for fail to connect eap-tls*/
/*=============================================================================*/
#include "includes.h"
				     ...
				     size_t *len, u8 *flags)
{
	...
	if (*flags & EAP_TLS_FLAGS_LENGTH_INCLUDED) {
		...
		pos += 4;
		left -= 4;
//[BUGFIX]-MOD-ADD by TCTNB.ZhangJie,12/05/2012,359556,
//Add patch for fail to connect eap-tls
		if (left > tls_msg_len) {
...
//[BUGFIX]-MOD-ADD by TCTNB.ZhangJie
	}
