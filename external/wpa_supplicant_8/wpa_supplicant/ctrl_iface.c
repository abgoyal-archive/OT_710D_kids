...
//[BUGFIX]-Add-BEGIN by TCTNB.Fan.He,02/01/2013,PR-393597
		...
		wpas_connect_from_framework(wpa_s, 10);
		wpa_printf(MSG_DEBUG, "FR200 Reconnect %s", wpa_s->ifname);
#endif
...
//[BUGFIX]-Add-BEGIN by TCTNB.Fan.He,02/01/2013,PR-393597
#ifdef DISCONNECT_P2P_IF_USER_CONNECTS_DIFFERENT_CHANNEL_AP
		wpas_connect_from_framework(wpa_s, WPS_PBC_WALK_TIME);
		wpa_printf(MSG_DEBUG, "FR200 WPS_PBC %s", wpa_s->ifname);
#endif
//[BUGFIX]-Add-END by TCTNB.Fan.He
...
//[BUGFIX]-Add-BEGIN by TCTNB.Fan.He,02/01/2013,PR-393597
			...
			wpa_printf(MSG_DEBUG, "FR200 PBC-OVERLAP %s", wpa_s->ifname);
#endif
//[BUGFIX]-Add-END by TCTNB.Fan.He
...
#ifdef DISCONNECT_P2P_IF_USER_CONNECTS_DIFFERENT_CHANNEL_AP
		wpas_connect_from_framework(wpa_s, WPS_PBC_WALK_TIME);
		wpa_printf(MSG_DEBUG, "FR200 WPS_PIN %s", wpa_s->ifname);
#endif
//[BUGFIX]-Add-END by TCTNB.Fan.He
...
#ifdef DISCONNECT_P2P_IF_USER_CONNECTS_DIFFERENT_CHANNEL_AP
		wpas_connect_from_framework(wpa_s, 0);
		wpa_printf(MSG_DEBUG, "FR200 WPS_CANCEL %s", wpa_s->ifname);
#endif
//[BUGFIX]-Add-END by TCTNB.Fan.He
...
#ifdef DISCONNECT_P2P_IF_USER_CONNECTS_DIFFERENT_CHANNEL_AP
		wpas_connect_from_framework(wpa_s, 0);
		wpa_printf(MSG_DEBUG, "FR200 REMOVE_NETWORK %s", wpa_s->ifname);
#endif
//[BUGFIX]-Add-END by TCTNB.Fan.He
