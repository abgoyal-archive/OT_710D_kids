...
/* ----------|----------------------|----------------------|----------------- */
/* 12/17/2012|Yu.Feng               |PR360782              |[WiFi]Don't conne */
/*           |                      |                      |ct to WPS network */
/*           |                      |                      | while network is */
/*           |                      |                      | connected        */
/* ----------|----------------------|----------------------|----------------- */
...
{
//[DUGFIX]-Mod-BEGIN by TCTNB.Yu.Feng,12/17/2012,360782,WPS Connect Wrong
    if(wpa_s!=NULL && wpa_s->current_ssid !=NULL && wpa_s->current_ssid->ssid !=NULL) {
         wpa_msg(wpa_s, MSG_INFO, WPS_EVENT_SUCCESS " id=%d", wpa_s->current_ssid->id);
    } else {
         wpa_msg(wpa_s, MSG_INFO, WPS_EVENT_SUCCESS);
    }
//[DUGFIX]-Mod-END by TCTNB.Yu.Feng
	wpa_s->wps_success = 1;
