...
/* 04/03/2013|ZhangLu               |CR-399266             |second source     */
/* ----------|----------------------|----------------------|----------------- */
/******************************************************************************/
...
extern uint8_t ov5647_customer_id;
			...
			int update_type, int res)
{
	...
	if (update_type == MSM_SENSOR_REG_INIT) {
		...
		//[BUGFIX]-Add by TCTBN.XuNan,12/11/2012,PR347828,time performance
		is_first_preivew = 1;
//[PLATFORM]-Mod-BEGIN by TCTNB.ZL 2013/04/03, for scribe5-ov5647's OTP, bug371680
		...
		msm_camera_i2c_write(s_ctrl->sensor_i2c_client, 0x100, 0x0,
		  MSM_CAMERA_I2C_BYTE_DATA);
//[PLATFORM]-Mod-END by TCTNB.ZL 2013/04/03, for scribe5-ov5647's OTP, bug371680
...
int32_t ov5647_get_module_id(void){
       CDBG("%s=%d\n",__func__,ov5647_customer_id);
       return ov5647_customer_id;
}
...
static struct msm_sensor_fn_t ov5647_func_tbl = {
	...
	.sensor_get_module_id = ov5647_get_module_id,
};
